      ...
      >
        <div className="absolute inset-0 rounded-lg md:rounded-2xl bg-black/60 flex items-center justify-center">
          <div className="text-center text-white px-4 sm:px-6 md:px-8 max-w-4xl">
            ...
            <button onClick={()=>navigate('/products')} className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 sm:py-2.5 sm:px-5 md:py-3 md:px-6 lg:py-3 lg:px-8 text-sm sm:text-base rounded-lg transition duration-300 hover:scale-105">
              Shop Now
            </button>
          </div>
        </div>
